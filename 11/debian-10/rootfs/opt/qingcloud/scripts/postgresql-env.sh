...
# Paths
export POSTGRESQL_VOLUME_DIR="/qingcloud/postgresql"
export POSTGRESQL_BASE_DIR="/opt/qingcloud/postgresql"
...
export NSS_WRAPPER_LIB="/opt/qingcloud/common/lib/libnss_wrapper.so"

# Paths (Replication Manager)
export PATH="/opt/qingcloud/repmgr/bin:/opt/qingcloud/common/bin:$PATH"
export REPMGR_BASE_DIR="/opt/qingcloud/repmgr"
export REPMGR_CONF_DIR="$REPMGR_BASE_DIR/conf"
export REPMGR_VOLUME_DIR="/qingcloud/repmgr"
